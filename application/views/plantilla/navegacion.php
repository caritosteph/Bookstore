...
<div class="header">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse color2 redondear" role="navigation">
            <ul class="nav nav-justified">
                ...
                <li class="<?= $activo == 'catalogo' ? 'active' : 'barra' ?>"><a href="<?php echo base_url(); ?>catalogo" onclick="return onCatalogo();" class="nav-text"> <span class="glyphicon glyphicon-book"></span> CATÁLOGO</a></li>
