                ...
                <form method="post" action="#">
                    ...
                    <div class="container col-lg-6 centrado1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fecha" name="fecha" placeholder="Ingresar fecha" required>
                                   <?php echo form_error('fecha'); ?>
                        </div>
                        <div class="form-group">
                            <label for="email">Gastos de envio</label>
                            <input type="text" class="form-control" id="autor" name="email" placeholder="Ingresar correo electronico" required>
                                   <?php echo form_error('email'); ?>
                        </div>

                        <div class="form-group">
                            <label for="contrasena">Precio sin IGV</label>
