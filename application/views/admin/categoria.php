                ...
                <?php foreach ($categorias as $c) { ?>
                    ...
                    <tr>
                        ...
                        <td class="media-body"><a href="<?=base_url()?>admin/categoria/modificar/<?= $c->id?>" class="btn btn-sm btn-primary text-center"><span class="glyphicon glyphicon-pencil"></span></a> 
                            <a href="<?=base_url()?>admin/categoria/eliminar/<?=$c->id?>"><button type="button" class="confirmar btn btn-sm btn-danger" name='eliminar'><span class="glyphicon glyphicon-remove"></span></button></a>
                        </td>
                    </tr>
